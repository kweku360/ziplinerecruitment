...
*/
  ...
  $footer_top_cta_content  = get_theme_mod('footer_top_cta_content', __('Feel free to customize this paragraph to better reflect the
  ...
  if ( is_active_sidebar('footer-4-1') OR is_active_sidebar('footer-4-2') OR is_active_sidebar('footer-4-3') OR is_active_sidebar('footer-4-4') ){
...
<div class="footer-cta5"
     style="background-image:url(<?php echo esc_url($bg_img ); ?>); background-color:<?php echo esc_attr($bg_color); ?>">
     ...
     <!--===== FOOTER AREA START =======-->
     <div class="footer5 _relative <?php echo esc_attr($footertopSpecing); ?>" style="background-image:url(<?php echo esc_url($bg_img ); ?>); background-color:<?php echo esc_attr($bg_color); ?>">
