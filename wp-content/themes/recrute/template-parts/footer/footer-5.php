...
$footer_cta_image_img = !empty($recrute_footer_cta_image_url_from_page['url']) ? $recrute_footer_cta_image_url_from_page['url'] : $cta_image;
  ...
  if($footer_cta_switch == true){
     $footer_cta_spacing = 'footer-cta-spacing';
  }
...
<!--=====CTA AREA START=======-->
<div class="cta2 cta-index-5">
     <div class="container">
          <div class="cta2-bg" style="background-image:url(<?php echo esc_url($footer_cta_bg_img ); ?>); background-color:<?php echo esc_attr($footer_cta_bg_color); ?>">
               <div class="row">
...
<div class="footer2 _relative <?php echo esc_attr($footer_cta_spacing); ?>" style="background-image:url(<?php echo esc_url($bg_img ); ?>); background-color:<?php echo esc_attr($bg_color); ?>">
