...
<!--===== FOOTER AREA START =======-->
<div class="footer3 _relative <?php echo esc_attr($footer_cta_spacing); ?>" style="background-image:url(<?php echo esc_url($bg_img ); ?>); background-color:<?php echo esc_attr($bg_color); ?>">
