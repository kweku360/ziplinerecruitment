...
$footer_cta_image_img = !empty($recrute_footer_cta_image_url_from_page['url']) ? $recrute_footer_cta_image_url_from_page['url'] : $cta_image;
  ...
  if ( is_active_sidebar('footer-9-1') OR is_active_sidebar('footer-9-2') OR is_active_sidebar('footer-9-3') OR is_active_sidebar('footer-9-4') ){
...
<!--=====CTA AREA START=======-->
<div class="cta9" style="background-image:url(<?php echo esc_url($footer_cta_bg_img ); ?>); background-color:<?php echo esc_attr($footer_cta_bg_color); ?>">
     <div class="container">
          <div class="row">
               <div class="col-lg-5">
...
<!--===== FOOTER AREA START =======-->
<div class="footer9 _relative <?php echo esc_attr($footertopSpecing); ?>" style="background-image:url(<?php echo esc_url($bg_img ); ?>); background-color:<?php echo esc_attr($bg_color); ?>">
