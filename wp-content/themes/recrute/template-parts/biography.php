<?php
    ...
    $author_info = get_the_author_meta( 'recrute_write_by');
    $facebook_url = get_the_author_meta( 'recrute_facebook' );
    $twitter_url = get_the_author_meta( 'recrute_twitter' );
    $linkedin_url = get_the_author_meta( 'recrute_linkedin' );
    $instagram_url = get_the_author_meta( 'recrute_instagram' );
    $recrute_url = get_the_author_meta( 'recrute_youtube' );
    $recrute_write_by = get_the_author_meta( 'recrute_write_by' );
