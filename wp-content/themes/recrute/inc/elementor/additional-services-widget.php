<?php
/**
 * Additional Services Widget for Elementor (Recrute)
 *
 * @package recrute
 */
...
class Recrute_Additional_Services_Widget extends \Elementor\Widget_Base {
    public function get_name() {
        return 'recrute_additional_services';
    }
    public function get_title() {
        return esc_html__('Additional Services', 'recrute');
    }
...
add_action('elementor/widgets/register', function($widgets_manager) {
    $widgets_manager->register( new Recrute_Additional_Services_Widget() );
}); 