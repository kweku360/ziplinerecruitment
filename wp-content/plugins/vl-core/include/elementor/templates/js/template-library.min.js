!function($, $ele, $i) {
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, vlcoreEditor.i18n)
    };
    ...
    $app.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
        ...
        template: "#vlcore-liteTemplateLibrary_empty",
        ui: {
    ...
    $app.Views.Loading = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_loading",
        id: "liteTemplateLibrary_loading"
    }), 
    $app.Views.Logo = Marionette.ItemView.extend({
        template: "#vlcore-harry-template-library-header-logo",
    ...
    $app.Views.BackButton = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_header-back",
    ...
    $app.Views.Menu = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_header-menu",
    ...
    $app.Views.ResponsiveMenu = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_header-menu-responsive",
    ...
    $app.Views.Actions = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_header-actions",
    ...
    $app.Views.InsertWrapper = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_header-insert",
    ...
    $app.Views.Preview = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_preview",
    ...
    $app.Views.TemplateCollection = Marionette.CompositeView.extend({
        template: "#vlcore-liteTemplateLibrary_templates",
    ...
    $app.Views.Template = Marionette.ItemView.extend({
        template: "#vlcore-liteTemplateLibrary_template",
    ...
    $app.Modal = elementorModules.common.views.modal.Layout.extend({
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !vlcoreEditor.hasPro ? "pro-button" : "insert-button";
            return viewId = "#vlcore-liteTemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".tp_templates_add_button").length || $sl.find(DROIT_FIND_SELECTOR).before($vlcorePpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(DROIT_FIND_SELECTOR);
            $t.length && !$el.find(".tp_templates_add_button").length && $t.before($vlcorePpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }
        ...
        $vlcorePpenLibraryButton = '<div class="elementor-add-section-area-button tp_templates_add_button"> <img src="'+vlcoreEditor.templateLogo+'" /> </div>', 
        $tpResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
        ...
        this.init = function() {
            $this.setFilter("type", vlcoreEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
        }, 
        this.getTabs = function() {
            var e = this.getFilter("type");
            return tabs = JSON.parse(vlcoreEditor.tab_style)
        ...
        this.requestLibraryData = function(e) {
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_vlcore_library_data", t)
        }, 
        this.requestTemplateData = function(e, t) {
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_vlcore_template_data", i)
        }, 
...
}(jQuery, window.elementor, window.vlcore || {});
