...
class TP_Templates
{
    ...
    public function init()
    {
        ...
        //     wp_enqueue_style( "vlcore-el-template-front", self::url() . 'css/template-frontend.min.css' , ['elementor-frontend'], self::version() );  
        //     } 
        // );
        ...
        add_action( 'elementor/editor/after_enqueue_scripts', function() {     
            ...
            $localize_data = [
                ...
                'i18n' => [
                    'templatesEmptyTitle'       => esc_html__( 'No Templates Found', 'vlcore' ),
                    'templatesEmptyMessage'     => esc_html__( 'Try different category or sync for new templates.', 'vlcore' ),
                    'templatesNoResultsTitle'   => esc_html__( 'No Results Found', 'vlcore' ),
                    'templatesNoResultsMessage' => esc_html__( 'Please make sure your search is spelled correctly or try a different words.', 'vlcore' ),
                ],
        ...
        add_action( 'elementor/preview/enqueue_styles', function(){
            ...
            ';
            wp_add_inline_style( 'vlcore-el-template-front', $data );
        } );
    }
