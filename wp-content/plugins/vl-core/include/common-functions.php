...
use VLcore\Elementor\Controls\Group_Control_TPBGGradient;
use VLcore\Elementor\Controls\Group_Control_TPGradient;
 ...
 */
function vl_get_all_types_post($post_type)
{
 ...
 */
function vl_get_orderby_options()
{
    $orderby = array(
        'ID' => 'Post ID',
        'author' => 'Post Author',
 ...
 * Get Post Categories
 */
function vl_get_categories($taxonomy)
{
 ...
 * Get all Pages
 */
if (!function_exists('vl_get_pages')) {
    function vl_get_pages()
    {
...
function tp_get_allowed_html_desc($level = 'basic')
{
    ...
    return sprintf(__('This input field has support for the following HTML tags: %1$s', 'vlcore'), '<code>' . esc_html($tags_str) . '</code>');
}
 ...
 */
if(!function_exists('vl_render_icon')){
...
trait VLcoreElementFunctions
{
     ...
     */
    protected function tp_icon_style($control_id = null, $control_name = null, $selector = null, $condition = 'layout-1'){
    ...
    */
    ...
    protected function tp_basic_style_controls($control_id = null, $control_name = null, $control_selector = null, $condition = 'layout-1')
    {
    ...
    */
    ...
    protected function tp_link_controls_style($control_id = null, $control_name = null, $control_selector = null, $condition = 'layout-1')
    {
        /**
         * Button One
         */
        ...
        $this->add_group_control(
			...
			[
				'name' => 'tp_' . $control_id . '_normal_btn_bg',
				'types' => ['gradient'],
				'selector' => '{{WRAPPER}} '. $control_selector,
			]
		);
        ...
        $this->add_group_control(
			\Elementor\Group_Control_Background::get_type(),
			[
				'name' => 'tp_' . $control_id . '_hover_btn_bg',
				'types' => ['gradient'],
    ...
    */
    protected function tp_button_render_controls($control_id = 'button', $control_name = 'Button', $default_btn_text = 'Read More', $default_btn_enable = 'yes')
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__($control_name, 'vlcore'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Text', 'vlcore'),
                'type' => Controls_Manager::TEXT,
                'default' => $default_btn_text,
                'title' => esc_html__('Enter button text', 'vlcore'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Link Type', 'vlcore'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1' => 'Custom Link',
                    '2' => 'Internal Page',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' link', 'vlcore'),
                'type' => Controls_Manager::URL,
                'dynamic' => [
                    'active' => true,
                ],
                'placeholder' => esc_html__('https://your-link.com', 'vlcore'),
                'show_external' => false,
                'default' => [
                    'url' => '#',
                    'is_external' => false,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Select ' . $control_name . ' Page', 'vlcore'),
    ...
    */
    protected function tp_section_title_render_controls($control_id = null, $section_name = 'Section Title',  $sub_title = 'Sub Title', $default_title = 'Your Section Title', $default_description = 'There are many variations of passages of Lorem Ipsum available, <br /> but the majority have suffered alteration.', $control_condition = 'layout-1', $default_title_tag = 'h2', $default_align = '',  $enable_section_title_show_hide = true, $default_section_title_enable = 'yes')
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__($section_name, 'vlcore'),
                'condition' => [
        ...
        if ($enable_section_title_show_hide){
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Section Title & Content', 'vlcore' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => $sub_title,
                'placeholder' => esc_html__('Type Before Heading Text', 'vlcore'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('Type Heading Text', 'vlcore'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title HTML Tag', 'vlcore'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'h1' => [
                        'title' => esc_html__('H1', 'vlcore'),
                        'icon' => 'eicon-editor-h1'
                    ],
                    'h2' => [
                        'title' => esc_html__('H2', 'vlcore'),
                        'icon' => 'eicon-editor-h2'
                    ],
                    'h3' => [
                        'title' => esc_html__('H3', 'vlcore'),
                        'icon' => 'eicon-editor-h3'
                    ],
                    'h4' => [
                        'title' => esc_html__('H4', 'vlcore'),
                        'icon' => 'eicon-editor-h4'
                    ],
                    'h5' => [
                        'title' => esc_html__('H5', 'vlcore'),
                        'icon' => 'eicon-editor-h5'
                    ],
                    'h6' => [
                        'title' => esc_html__('H6', 'vlcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('Type section description here', 'vlcore'),
            ]
        );
        $this->add_responsive_control(
    ...
    */
    ...
    protected function tp_columns($control_id = 'columns_options', $control_condition = 'layout-1', $control_name = 'Select Columns', $default_for_lg = '4', $default_for_md = '6', $default_for_sm = '6', $default_for_all = '12'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Desktop', 'vlcore' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1200px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'vlcore' ),
                    6 => esc_html__( '2 Columns', 'vlcore' ),
                    4 => esc_html__( '3 Columns', 'vlcore' ),
                    3 => esc_html__( '4 Columns', 'vlcore' ),
                    5 => esc_html__( '5 Columns (For Carousel Item)', 'vlcore' ),
                    2 => esc_html__( '6 Columns', 'vlcore' ),
                    1 => esc_html__( '12 Columns', 'vlcore' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Large', 'vlcore' ),
                'description' => esc_html__( 'Screen width equal to or greater than 992px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'vlcore' ),
                    6 => esc_html__( '2 Columns', 'vlcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Tablet', 'vlcore' ),
                'description' => esc_html__( 'Screen width equal to or greater than 768px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'vlcore' ),
                    6 => esc_html__( '2 Columns', 'vlcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'vlcore' ),
                'description' => esc_html__( 'Screen width less than 767px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'vlcore' ),
                    6 => esc_html__( '2 Columns', 'vlcore' ),
    ...
    */
    protected function tp_columns_carousel($control_id = 'carousel_columns_options', $control_name = 'Select Columns', $default_for_xl = '4', $default_for_lg = '4', $default_for_md = '3', $default_for_sm = '2', $default_for_all = '1', $default_for_xs = '1'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Large Desktop', 'vlcore' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1920px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'vlcore' ),
                    2 => esc_html__( '2 Columns', 'vlcore' ),
                    3 => esc_html__( '3 Columns', 'vlcore' ),
                    4 => esc_html__( '4 Columns', 'vlcore' ),
                    5 => esc_html__( '5 Columns', 'vlcore' ),
                    6 => esc_html__( '6 Columns', 'vlcore' ),
                    7 => esc_html__( '7 Columns', 'vlcore' ),
                    8 => esc_html__( '8 Columns', 'vlcore' ),
                    9 => esc_html__( '9 Columns', 'vlcore' ),
                    10 => esc_html__( '10 Columns', 'vlcore' ),
                    11 => esc_html__( '10 Columns', 'vlcore' ),
                    12 => esc_html__( '12 Columns', 'vlcore' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            'tp_' . $control_id . '_for_laptop',
            [
                'label' => esc_html__( 'Columns for Laptop', 'vlcore' ),
                'description' => esc_html__( 'Screen width equal to or greater than 992px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'vlcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'vlcore' ),
                'description' => esc_html__( 'Screen width less than 767', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'vlcore' ),
                    2 => esc_html__( '2 Columns', 'vlcore' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Small Mobile', 'vlcore' ),
                'description' => esc_html__( 'Screen width less than 575px', 'vlcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'vlcore' ),
                    2 => esc_html__( '2 Columns', 'vlcore' ),
    ...
    */
    ...
    protected function tp_button_render($control_id = null, $control_name = 'box', $control_condition = 'layout-1'){
        $this->start_controls_section(
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( 'Add '.$control_name.' link', 'vlcore' ),
                   'type' => \Elementor\Controls_Manager::SWITCHER,
                   'label_on' => esc_html__( 'Yes', 'vlcore' ),
                   'label_off' => esc_html__( 'No', 'vlcore' ),
                   'return_value' => 'yes',
                   'default' => 'yes',
                   'separator' => 'before',
               ]
           ...
           $this->add_control(
               ...
               [
                   ...
                   'type' => Controls_Manager::TEXT,
                   'default' => esc_html__('Button Text', 'vlcore'),
                   'title' => esc_html__('Enter button text', 'vlcore'),
                   'label_block' => true,
                   'condition' => [
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( ''.$control_name.' Link link', 'vlcore' ),
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( 'Select '.$control_name.' Link Page', 'vlcore' ),
    ...
    protected function tp_query_controls($control_id = null, $control_name = null, $post_type = 'post', $taxonomy = 'category', $default_title_num = 6, $default_content_limit = '10', $posts_per_page = '6', $offset = '0', $orderby = 'date', $order = 'desc')
    {

        $this->start_controls_section(
            'tp' . $control_id . '_query',
            [
                'label' => sprintf(esc_html__('%s Query', 'vlcore'), $control_name),
            ]
        );
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => esc_html__('Posts Per Page', 'vlcore'),
                'description' => esc_html__('Leave blank or enter -1 for all.', 'vlcore'),
        ...
        $this->add_control(
            'category',
            [
                'label' => esc_html__('Include Categories', 'vlcore'),
                'description' => esc_html__('Select a category to include or leave blank for all.', 'vlcore'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
        ...
        $this->add_control(
            'exclude_category',
            [
                'label' => esc_html__('Exclude Categories', 'vlcore'),
                'description' => esc_html__('Select a category to exclude', 'vlcore'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => vl_get_categories($taxonomy),
                'label_block' => true
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => esc_html__('Exclude Item', 'vlcore'),
                'type' => Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'offset',
            [
                'label' => esc_html__('Offset', 'vlcore'),
                'type' => Controls_Manager::NUMBER,
                'default' => $offset,
            ]
        );
        $this->add_control(
            'orderby',
            [
                'label' => esc_html__('Order By', 'vlcore'),
                'type' => Controls_Manager::SELECT,
                'options' => vl_get_orderby_options(),
                'default' => $orderby,
        ...
        $this->add_control(
            'order',
            [
                'label' => esc_html__('Order', 'vlcore'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' 	=> esc_html__( 'Ascending', 'vlcore' ),
                    'desc' 	=> esc_html__( 'Descending', 'vlcore' )
                ],
                'default' => $order,
        ...
        $this->add_control(
            'ignore_sticky_posts',
            [
                'label' => esc_html__( 'Ignore Sticky Posts', 'vlcore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'vlcore' ),
                'label_off' => esc_html__( 'No', 'vlcore' ),
                'return_value' => 'yes',
        ...
        if ($post_type !== 'product') {
            ...
            $this->add_control(
                'tp_post_pagination',
                [
                    'label' => __('Pagination Switch', 'tp-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Show', 'tp-core'),
                    'label_off' => __('Hide', 'tp-core'),
                    'return_value' => 'yes',
    ...
    protected function tp_post_layout($control_id = null, $control_name = null){
        $this->start_controls_section(
            'tp_'. $control_id .'_',
            [
                'label' => sprintf(esc_html__('%s - Layout', 'vlcore'), $control_name),
            ]
        );
        $this->add_control(
            'tp_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Grid', 'vlcore'),
                    'layout-2' => esc_html__('Blog Slider', 'vlcore'),
                    'layout-3' => esc_html__('Blog Box', 'vlcore'),
                    'layout-4' => esc_html__('Blog 2 Col', 'vlcore'),
                    'layout-5' => esc_html__('Blog 3 Col', 'vlcore'),
                    'layout-6' => esc_html__('Blog List', 'vlcore'),
                    'layout-7' => esc_html__('Blog 3 Col Style 2', 'vlcore'),
                    'layout-8' => esc_html__('Blog 2 Col Slider', 'vlcore'),
                    'layout-9' => esc_html__('Blog Large', 'vlcore'),
                    'layout-10' => esc_html__('Blog Overlay', 'vlcore'),
                    'layout-11' => esc_html__('Blog Small', 'vlcore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
         'enable_style_2',
         [
           'label'        => esc_html__( 'Enable Style 2', 'vlcore' ),
           'type'         => \Elementor\Controls_Manager::SWITCHER,
           'label_on'     => esc_html__( 'Show', 'vlcore' ),
           'label_off'    => esc_html__( 'Hide', 'vlcore' ),
           'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Height', 'vlcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Arrow Icons?', 'vlcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'vlcore'),
                'label_off' => esc_html__('Hide', 'vlcore'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Infinite?', 'vlcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'vlcore'),
                'label_off' => esc_html__('No', 'vlcore'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Autoplay?', 'vlcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'vlcore'),
                'label_off' => esc_html__('No', 'vlcore'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Autoplay Speed', 'vlcore'),
                'type' => Controls_Manager::TEXT,
                'default' => '2500',
                'title' => esc_html__('Enter autoplay speed', 'vlcore'),
                'label_block' => true,
                'condition' => array(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Filter?', 'vlcore'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'vlcore'),
                'label_off' => esc_html__('No', 'vlcore'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Pagination', 'vlcore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'vlcore' ),
                'label_off' => esc_html__( 'Hide', 'vlcore' ),
                'return_value' => 'yes',
    ...
    protected function tp_post_layout_2($control_id = null, $control_name = null){
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Full Slider', 'vlcore'),
                    'layout-2' => esc_html__('Blog Grid', 'vlcore'),
                    'layout-3' => esc_html__('Blog List', 'vlcore'),
                    'layout-4' => esc_html__('Blog Masonary', 'vlcore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
         'enable_sidebar',
            [
                'label'        => esc_html__( 'Enable Sidebar ?', 'vlcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'vlcore' ),
                'label_off'    => esc_html__( 'Hide', 'vlcore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
         'enable_border_style_sidebar',
            [
                'label'        => esc_html__( 'Enable Border Style For Sidebar', 'vlcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'vlcore' ),
                'label_off'    => esc_html__( 'Hide', 'vlcore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
         'enable_border_style_item',
            [
                'label'        => esc_html__( 'Enable Border Style For Item', 'vlcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'vlcore' ),
                'label_off'    => esc_html__( 'Hide', 'vlcore' ),
                'return_value' => 'yes',
    ...
    protected function tp_post_carousel_col($control_id = null, $control_name = null){
        $this->start_controls_section(
            ...
            [
                'label' => sprintf(esc_html__('%s - Columns for Carousel', 'vlcore'), $control_name),
            ]
        );
    ...
    protected function tp_icon_controls($control_id = null, $control_condition = 'layout-2'){
        ...
        if($control_condition){
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Select Icon Type', 'vlcore'),
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'image',
                    'options' => [
                        'image' => esc_html__('Image', 'vlcore'),
                        'icon' => esc_html__('Icon', 'vlcore'),
                        'svg' => esc_html__('SVG', 'vlcore'),
                    ],
                    'condition' => [
                        'tp_design_style' => $control_condition 
                      ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXTAREA,
                    'label_block' => true,
                    'placeholder' => esc_html__('SVG Code Here', 'vlcore'),
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Upload Icon Image', 'vlcore'),
    ...
    protected function tp_price_currency($control_id = null, $control_name = 'Silver Plan'){
        ...
        $this->add_control(
            ''. $control_id .'_title',
         [
            'label'       => esc_html__( 'Price Title', 'vlcore' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'default' => sprintf(esc_html__('%s', 'vlcore'), $control_name),
            'placeholder' => esc_html__( 'Your title here', 'vlcore' ),
         ]
        );
        ...
        $this->add_control(
            ''. $control_id .'_desc',
         [
           'label'       => esc_html__( 'Price Description', 'vlcore' ),
           'type'        => \Elementor\Controls_Manager::TEXTAREA,
           'rows'        => 10,
           'default'     => esc_html__( 'Free forever,! No credit card required.', 'vlcore' ),
           'placeholder' => esc_html__( 'Your Description Here', 'vlcore' ),
         ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Currency', 'vlcore'),
                'type' => Controls_Manager::SELECT,
                'label_block' => false,
                'options' => [
                    '' => __('None', 'vlcore'),
                    'baht' => '&#3647; ' . _x('Baht', 'Currency Symbol', 'vlcore'),
                    'bdt' => '&#2547; ' . _x('BD Taka', 'Currency Symbol', 'vlcore'),
                    'dollar' => '&#36; ' . _x('Dollar', 'Currency Symbol', 'vlcore'),
                    'euro' => '&#128; ' . _x('Euro', 'Currency Symbol', 'vlcore'),
                    'franc' => '&#8355; ' . _x('Franc', 'Currency Symbol', 'vlcore'),
                    'guilder' => '&fnof; ' . _x('Guilder', 'Currency Symbol', 'vlcore'),
                    'krona' => 'kr ' . _x('Krona', 'Currency Symbol', 'vlcore'),
                    'lira' => '&#8356; ' . _x('Lira', 'Currency Symbol', 'vlcore'),
                    'peso' => '&#8369; ' . _x('Peso', 'Currency Symbol', 'vlcore'),
                    'pound' => '&#163; ' . _x('Pound Sterling', 'Currency Symbol', 'vlcore'),
                    'real' => 'R$ ' . _x('Real', 'Currency Symbol', 'vlcore'),
                    'ruble' => '&#8381; ' . _x('Ruble', 'Currency Symbol', 'vlcore'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency Symbol', 'vlcore'),
                    'shekel' => '&#8362; ' . _x('Shekel', 'Currency Symbol', 'vlcore'),
                    'won' => '&#8361; ' . _x('Won', 'Currency Symbol', 'vlcore'),
                    'yen' => '&#165; ' . _x('Yen/Yuan', 'Currency Symbol', 'vlcore'),
                    'custom' => __('Custom', 'vlcore'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ''. $control_id .'_period',
            [
                'label' => __('Period', 'vlcore'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Per Month', 'vlcore'),
                'dynamic' => [
                    'active' => true
                ]
            ]
