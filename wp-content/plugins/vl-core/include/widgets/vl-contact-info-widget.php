<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'vl_contact_info_widget');
	function vl_contact_info_widget() {
		register_widget('vl_contact_info_widget');
	}
	
	
	class vl_contact_info_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('vl_contact_info_widget',esc_html__('VL Contact Info', 'vlcore'),array(
				'description' => esc_html__('VL Contact Info Widget', 'vlcore'),
			));
		}
		...
		public function form($instance){
			...
			<p>
				<label for="title"><?php esc_html_e('Address:','vlcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Email Address:','vlcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Phone Number:','vlcore'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Website Url:','vlcore'); ?></label>
			</p>
