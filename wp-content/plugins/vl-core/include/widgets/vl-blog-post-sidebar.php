...
Class VL_Post_Sidebar_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-latest-posts', 'VL Blog Posts Image', array(
			'description'	=> 'Latest Blog Post Widget by Vikinglab'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('VL_Post_Sidebar_Widget');
});