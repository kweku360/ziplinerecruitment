...
Class VL_Post_Service_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-latest-service-posts', 'VL Service Posts Image', array(
			'description'	=> 'Latest Service Post Widget by Vikinglab'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('VL_Post_Service_Widget');
});