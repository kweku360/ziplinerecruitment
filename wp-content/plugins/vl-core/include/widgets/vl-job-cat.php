<?php 
Class Latest_Job_Cat_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-job-cats-list', 'VL Job Category', array(
			'description'	=> 'VL Job Category'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('Latest_Job_Cat_List_Widget');
});