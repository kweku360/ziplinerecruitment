<?php
Class VL_Donasion_Posts_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct( 'vl-donasion-posts', 'VL Donasion Posts', [
            'description' => 'Donasion Post Widget by Vikinglab',
        ] );
    }
...
add_action( 'widgets_init', function () {
    register_widget( 'VL_Donasion_Posts_Widget' );
} );