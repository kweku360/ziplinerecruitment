<?php 
Class Latest_Project_Cat_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-project-cats-list', 'VL Project Category', array(
			'description'	=> 'VL Project Category'
		));
	}
...
add_action('widgets_init', function(){
	register_widget('Latest_Project_Cat_List_Widget');
});