<?php 
Class VL_Posts_Footer_IMG_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-latest-posts-footer-img', 'VL Footer Posts Image', array(
...
add_action('widgets_init', function(){
	register_widget('VL_Posts_Footer_IMG_Widget');
});