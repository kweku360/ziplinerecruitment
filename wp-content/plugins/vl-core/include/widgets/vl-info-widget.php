<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'VL_info_Widget');
	function VL_info_Widget() {
		register_widget('VL_info_Widget');
	}
	
	
	class VL_info_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('VL_info_Widget',esc_html__('VL Info','tocore'),array(
				'description' => esc_html__('VL Info Logo, Desc, Socials Widget','tocore'),
			));
		}
