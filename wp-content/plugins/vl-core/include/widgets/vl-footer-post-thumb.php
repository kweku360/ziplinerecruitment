<?php 
Class VL_Latest_Post_Footer_Thumb extends WP_Widget{

	public function __construct(){
		parent::__construct('vl-latest-posts-footer-thumb', 'VL Footer Posts Thumb', array(
...
add_action('widgets_init', function(){
	register_widget('VL_Latest_Post_Footer_Thumb');
});