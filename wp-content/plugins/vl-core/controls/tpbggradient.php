...
class Group_Control_TPBGGradient extends Group_Control_Base {
    ...
    public function init_fields() {
        ...
        $fields['color_type'] = [
            ...
            'description' => _x( 'Gradient color not work editor mode. If you set gradient color please view the result live preview page.', 'Background Control', 'vlcore' ),
            'type' => Controls_Manager::CHOOSE,
            'label_block' => false,
            'render_type' => 'ui',
            'options' => [
                'classic' => [
                    'title' => _x( 'Solid', 'Color Control', 'vlcore' ),
                    'icon' => 'eicon-paint-brush',
                ],
                'gradient' => [
                    'title' => _x( 'Gradient', 'Color Control', 'vlcore' ),
                    'icon' => 'eicon-barcode',
                ],
            ],
            'default' => 'classic'
        ...
        $fields['color'] = [
            ...
            'default' => '',
            'title' => _x( 'Start Color', 'Background Control', 'vlcore' ),
            'selectors' => [
        ...
        $fields['color_b'] = [
            'label' => _x( 'Second Color', 'Background Control', 'vlcore' ),
            'type' => Controls_Manager::COLOR,
            'default' => '#f2295b',
            'render_type' => 'ui',
            'condition' => [
